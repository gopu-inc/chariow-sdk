...
export interface StoreAppearance {
  ...
  font: {
    primary: { value: string; display_name: string; category: string; url: string }
    secondary: { value: string; display_name: string; category: string; url: string }
  }
  border_style: { value: string; label: string }
  product_order: { value: string; label: string }
  color: {
    primary: { hex: string; rgb: string }
    contrast: { hex: string; rgb: string }
  }
  show_featured_products: boolean
  show_purchase_button_on_product_card: boolean
  show_recommended_products: boolean
  products_per_row: number
  cta_animation_type: { value: string; label: string }
}
